// src/pages/ElectronicBettingReport/index.tsx
...
export default function ElectronicBettingReport() {
  const [viewMode, setViewMode] = useState<ViewMode>('list')
  const [selectedProvider, setSelectedProvider] = useState<string>('ATG')

  // 紀錄當前選中的資料，用於麵包屑導航
  const [currentGame, setCurrentGame] = useState<ElectronicBettingData | null>(
    null
  )
  ...
  // --- 導航 Actions ---
  const handleGoToGameDetail = (record: ElectronicBettingData) => {
