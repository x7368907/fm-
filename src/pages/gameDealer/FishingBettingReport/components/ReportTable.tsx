...
type ReportRow = FishingBettingData &
...
interface ReportTableProps {
  ...
  dataSource: FishingBettingData[] | GameDetailData[] | MemberDetailData[]
  totalData: any // 合計資料
  loading?: boolean
  onGoToGameDetail: (record: FishingBettingData) => void
  onGoToMemberDetail: (record: GameDetailData) => void
  onViewDetail: (record: MemberDetailData) => void // L3 的檢視按鈕(如果有)
}
